<?php
function pat_generate_m1_img( $id ) {
...
function pat_generate_m2_img( $id ) {
  ...
  $hide_datafacet1 = (count(($scores['m2']['1-enh'])??'') == 0 || count(($scores['m2']['1-enh'])??'') > 16 ) ? 'svg-hide' : '';
	...
	';
	$mod2_file_input_path = $upload_path.'/mod2diamond-'.$id.'.svg';
	$mod2_file_output_path = $upload_path.'/mod2diamond-'.$id.'.png';
	...
	$mod2_file_output_url = $upload_dir['baseurl'].'/pat-temp/mod2diamond-'.$id.'.png';

  return $mod2_file_output_url;
}

// Generate featured image function
